...
# E loss MC
scaleSetter.set(1, 0, 0.,  0.02, -0.10, 0.10) #par[1]
scaleSetter.set(1, 0, 0.,  0.03, -0.15, 0.15) #par[2]
scaleSetter.set(1, 0, 0.,  0.05, -0.25, 0.25) #par[3]
scaleSetter.set(1, 0, 0.,  0.05, -0.25, 0.25) #par[4]
# misalignment
