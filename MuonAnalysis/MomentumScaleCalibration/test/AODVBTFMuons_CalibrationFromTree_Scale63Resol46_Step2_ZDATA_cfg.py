...
scaleSetter.set(1, 0,-0.000878242, 0.0001, -0.01, 0.01)   #(1+par[0])
# E loss MC
...
# misalignment
scaleSetter.set(1, 0, 4.47221e-05, 0.0005, -0.005, 0.005) #par[5]
scaleSetter.set(1, 0,-1.82931e-05, 0.0005, -0.005, 0.005) #par[6]
scaleSetter.set(1, 0,-0.000156256, 0.0005, -0.005, 0.005) #par[7]
scaleSetter.set(1, 0,-0.000137075, 0.0005, -0.005, 0.005) #par[8]
scaleSetter.set(1, 0,-5.90196e-06, 0.0005, -0.005, 0.005) #par[9]
scaleSetter.set(1, 0,-1.81928e-05, 0.0005, -0.005, 0.005) #par[10]
scaleSetter.set(1, 0,-0.000123357, 0.0005, -0.005, 0.005) #par[11]
scaleSetter.set(1, 0,-2.44046e-05, 0.0005, -0.005, 0.005) #par[12]
scaleSetter.set(1, 0,-6.50495e-06, 0.0005, -0.005, 0.005) #par[13]
scaleSetter.set(1, 0,-2.42099e-05, 0.0005, -0.005, 0.005) #par[14]
scaleSetter.set(1, 0,-6.92112e-05, 0.0005, -0.005, 0.005) #par[15]
scaleSetter.set(1, 0,-5.98402e-05, 0.0005, -0.005, 0.005) #par[16]
scaleSetter.set(1, 0,-5.70443e-06, 0.0005, -0.005, 0.005) #par[17]
scaleSetter.set(1, 0, 6.09764e-06, 0.0005, -0.005, 0.005) #par[18]
scaleSetter.set(1, 0,-4.85898e-05, 0.0005, -0.005, 0.005) #par[19]
scaleSetter.set(1, 0,-3.00464e-05, 0.0005, -0.005, 0.005) #par[20]
scaleSetter.set(1, 0,-1.76481e-05, 0.0005, -0.005, 0.005) #par[21]
scaleSetter.set(1, 0,-1.37225e-05, 0.0005, -0.005, 0.005) #par[22]
scaleSetter.set(1, 0,-1.13961e-05, 0.0005, -0.005, 0.005) #par[23]
scaleSetter.set(1, 0,-3.23958e-05, 0.0005, -0.005, 0.005) #par[24]
scaleSetter.set(1, 0, 7.90721e-06, 0.0005, -0.005, 0.005) #par[25]
scaleSetter.set(1, 0,-3.44757e-06, 0.0005, -0.005, 0.005) #par[26]
scaleSetter.set(1, 0,-2.89505e-05, 0.0005, -0.005, 0.005) #par[27]
scaleSetter.set(1, 0,-2.98879e-05, 0.0005, -0.005, 0.005) #par[28]
scaleSetter.set(1, 0,-7.83566e-06, 0.0005, -0.005, 0.005) #par[29]
scaleSetter.set(1, 0,-1.69643e-06, 0.0005, -0.005, 0.005) #par[30]
scaleSetter.set(1, 0, 1.27968e-05, 0.0005, -0.005, 0.005) #par[31]
scaleSetter.set(1, 0, 1.07057e-05, 0.0005, -0.005, 0.005) #par[32]
scaleSetter.set(1, 0, 8.97848e-06, 0.0005, -0.005, 0.005) #par[33]
scaleSetter.set(1, 0, 2.80165e-07, 0.0005, -0.005, 0.005) #par[34]
scaleSetter.set(1, 0,-1.56359e-05, 0.0005, -0.005, 0.005) #par[35]
scaleSetter.set(1, 0,-1.89756e-05, 0.0005, -0.005, 0.005) #par[36]
scaleSetter.set(1, 0,-8.80363e-06, 0.0005, -0.005, 0.005) #par[37]
scaleSetter.set(1, 0,-2.00268e-05, 0.0005, -0.005, 0.005) #par[38]
scaleSetter.set(1, 0, 4.75011e-06, 0.0005, -0.005, 0.005) #par[39]
scaleSetter.set(1, 0,-5.58063e-06, 0.0005, -0.005, 0.005) #par[40]
scaleSetter.set(1, 0, 1.42653e-05, 0.0005, -0.005, 0.005) #par[41]
scaleSetter.set(1, 0, 4.12791e-06, 0.0005, -0.005, 0.005) #par[42]
scaleSetter.set(1, 0,-1.71302e-06, 0.0005, -0.005, 0.005) #par[43]
scaleSetter.set(1, 0,-1.78916e-05, 0.0005, -0.005, 0.005) #par[44]
scaleSetter.set(1, 0, 1.42082e-05, 0.0005, -0.005, 0.005) #par[45]
scaleSetter.set(1, 0,-2.51677e-05, 0.0005, -0.005, 0.005) #par[46]
scaleSetter.set(1, 0,-3.09563e-05, 0.0005, -0.005, 0.005) #par[47]
scaleSetter.set(1, 0,-4.65104e-05, 0.0005, -0.005, 0.005) #par[48]
scaleSetter.set(1, 0, 3.05699e-05, 0.0005, -0.005, 0.005) #par[49]
scaleSetter.set(1, 0, 2.91496e-05, 0.0005, -0.005, 0.005) #par[50]
scaleSetter.set(1, 0,-5.67788e-06, 0.0005, -0.005, 0.005) #par[51]
scaleSetter.set(1, 0,-3.34322e-05, 0.0005, -0.005, 0.005) #par[52]
scaleSetter.set(1, 0, 3.59797e-05, 0.0005, -0.005, 0.005) #par[53]
scaleSetter.set(1, 0,-1.34609e-05, 0.0005, -0.005, 0.005) #par[54]
scaleSetter.set(1, 0,-0.000116445, 0.0005, -0.005, 0.005) #par[55]
scaleSetter.set(1, 0,-0.000125308, 0.0005, -0.005, 0.005) #par[56]
scaleSetter.set(1, 0, 7.97122e-05, 0.0005, -0.005, 0.005) #par[57]
scaleSetter.set(1, 0, 5.9409e-05 , 0.0005, -0.005, 0.005) #par[58]
scaleSetter.set(1, 0, 0.	 , 0.0005, -0.005, 0.005) #par[59]
scaleSetter.set(1, 0, 4.77515e-05, 0.0005, -0.005, 0.005) #par[60]
