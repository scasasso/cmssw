...
scaleFunctionBase<double *> * scaleFunctionService( const int identifier )
{
  ...
  case ( 56 ): return ( new scaleFunctionType56<double * > ); break;
  case ( 57 ): return ( new scaleFunctionType57<double * > ); break;
  case ( 58 ): return ( new scaleFunctionType58<double * > ); break;
  case ( 59 ): return ( new scaleFunctionType59<double * > ); break;
  case ( 60 ): return ( new scaleFunctionType60<double * > ); break;
  case ( 61 ): return ( new scaleFunctionType61<double * > ); break;
  case ( 62 ): return ( new scaleFunctionType62<double * > ); break;
  case ( 63 ): return ( new scaleFunctionType63<double * > ); break;
  case ( 70 ): return ( new scaleFunctionType70<double * > ); break;
  case ( 71 ): return ( new scaleFunctionType71<double * > ); break;
...
scaleFunctionBase<std::vector<double> > * scaleFunctionVecService( const int identifier )
{
  ...
  case ( 56 ): return ( new scaleFunctionType56<std::vector<double> > ); break;
  case ( 57 ): return ( new scaleFunctionType57<std::vector<double> > ); break;
  case ( 58 ): return ( new scaleFunctionType58<std::vector<double> > ); break;
  case ( 59 ): return ( new scaleFunctionType59<std::vector<double> > ); break;
  case ( 60 ): return ( new scaleFunctionType60<std::vector<double> > ); break;
  case ( 61 ): return ( new scaleFunctionType61<std::vector<double> > ); break;
  case ( 62 ): return ( new scaleFunctionType62<std::vector<double> > ); break;
  case ( 63 ): return ( new scaleFunctionType63<std::vector<double> > ); break;
  case ( 70 ): return ( new scaleFunctionType70<std::vector<double> > ); break;
  case ( 71 ): return ( new scaleFunctionType71<std::vector<double> > ); break;
  default: std::cout << "Error: wrong identifier = " << identifier << std::endl; exit(1);
  }
}
...
backgroundFunctionBase * backgroundFunctionService( const int identifier, const double & lowerLimit, const double & upperLimit )
{
  ...
  case ( 12 ): return new backgroundFunctionType12(lowerLimit, upperLimit); break; // SC
  case ( 13 ): return new backgroundFunctionType13(lowerLimit, upperLimit); break; // SC
  case ( 14 ): return new backgroundFunctionType14(lowerLimit, upperLimit); break; // SC
  case ( 15 ): return new backgroundFunctionType15(lowerLimit, upperLimit); break; // SC
